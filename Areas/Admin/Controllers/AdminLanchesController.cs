...
namespace Lancheria.Areas.Admin.Controllers
{
    ...
    public class AdminLanchesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("LancheId,Nome,DescricaoCurta,DescricaoLonga,Preco,ImageUrl,ImageThumbnailUrl,IsLanchePreferido,EmEstoque,CateogoriaId")] Lanche lanche)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("LancheId,Nome,DescricaoCurta,DescricaoLonga,Preco,ImageUrl,ImageThumbnailUrl,IsLanchePreferido,EmEstoque,CateogoriaId")] Lanche lanche)
        {
